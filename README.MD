...
- Test successful build by running `docker run j00sko/eff-oopsla-artifact:oopsla2021 ./eff.exe examples/random.eff`. This runs a simple example and should produce:
